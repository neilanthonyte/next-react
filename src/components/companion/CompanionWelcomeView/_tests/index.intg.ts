...
import { CompanionWelcomeViewCtrl } from "./index.ctrl";

fixture("CompanionWelcomeView").page(
  "http://localhost:6060/#/CompanionWelcomeView",
);
 ...
 *
 * ```
 * PATTERN=./src/components/companion/CompanionWelcomeView/index.tsx yarn dev
 * yarn testcafe ./src/components/companion/CompanionWelcomeView/_tests/index.intg.ts
 * ```
 */
test("something happens", async (t) => {
  const selector = Selector(selectDemo("CompanionWelcomeView", "standard"));

  const component = new CompanionWelcomeViewCtrl(
