...
import { FoyerAnatomyViewCtrl } from "./index.ctrl";

fixture("FoyerAnatomyView").page("http://localhost:6060/#/FoyerAnatomyView");

/**
 * To run:
 *
 * ```
 * PATTERN=./src/components/foyer/FoyerAnatomyView/index.tsx yarn dev
 * yarn testcafe ./src/components/foyer/FoyerAnatomyView/_tests/index.intg.ts
 * ```
 */
test("something happens", async (t) => {
  const selector = Selector(selectDemo("FoyerAnatomyView", "standard"));

  const component = new FoyerAnatomyViewCtrl(
