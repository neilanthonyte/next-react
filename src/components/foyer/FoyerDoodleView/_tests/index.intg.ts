...
import { FoyerDoodleViewCtrl } from "./index.ctrl";

fixture("FoyerDoodleView").page("http://localhost:6060/#/FoyerDoodleView");

/**
 * To run:
 *
 * ```
 * PATTERN=./src/components/foyer/FoyerDoodleView/index.tsx yarn dev
 * yarn testcafe ./src/components/foyer/FoyerDoodleView/_tests/index.intg.ts
 * ```
 */
test("something happens", async (t) => {
  const selector = Selector(selectDemo("FoyerDoodleView", "standard"));

  const component = new FoyerDoodleViewCtrl(
