...
import { CollapsibleBlockCtrl } from "./index.ctrl";

fixture("CollapsibleBlock").page("http://localhost:6060/#/CollapsibleBlock");

/**
 * To run:
 *
 * ```
 * PATTERN=./src/components/structure/CollapsibleBlock/index.tsx yarn dev
 * yarn testcafe ./src/components/structure/CollapsibleBlock/_tests/index.intg.ts
 * ```
 */
test("something happens", async (t) => {
  const selector = Selector(selectDemo("CollapsibleBlock", "standard"));

  const component = new CollapsibleBlockCtrl(
