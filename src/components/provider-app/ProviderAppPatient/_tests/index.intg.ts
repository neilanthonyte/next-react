...
import { ProviderAppPatientCtrl } from "./index.ctrl";

fixture("ProviderAppPatient").page(
  "http://localhost:6060/#/ProviderAppPatient",
);
 ...
 *
 * ```
 * PATTERN=./src/components/provider-app/ProviderAppPatient/index.tsx yarn dev
 * yarn testcafe ./src/components/provider-app/ProviderAppPatient/_tests/index.intg.ts
 * ```
 */
test("something happens", async (t) => {
  const selector = Selector(selectDemo("ProviderAppPatient", "standard"));

  const component = new ProviderAppPatientCtrl(
